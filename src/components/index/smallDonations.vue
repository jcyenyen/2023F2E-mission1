  ...
  <section id="small-donations" class="containers mb-4 lg:flex lg:justify-between">
    <div class="lg:w-[40%] lg:flex lg:flex-col lg:justify-between">
      <div>
        ...
        <h3 class="title28 my-3 lg:mt-4">您的每筆捐款，<br />是每隻毛孩未來的大大動力！</h3>
      </div>
      <div class="w-[100%] bg-gray-500 text-primary-300 p-3 rounded-[16px] mb-4 lg:mb-[0px]">
      ...
      >
        <div class="flex flex-col justify-between">
          <div class="flex title28 mb-3 leading-[1.75rem]">
            ...
            <p>
              <template v-if="donation.donateMoney">
                <span class="body16 text-gray-300 me-2">NT$</span>{{ donation.donateMoney }}
              </template>
              <template v-else>
                <span class="leading-[1.75rem]"> 自訂贊助金額 </span>
              </template>
            </p>
          </div>
